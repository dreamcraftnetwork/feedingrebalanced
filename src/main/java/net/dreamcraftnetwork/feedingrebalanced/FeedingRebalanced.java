 ...
 *
 *    Keep the ElementsFeedingRebalanced object in this class and all calls to this object
...
public class FeedingRebalanced {
	...
	@Mod.Instance(MODID)
	public static FeedingRebalanced instance;
	public ElementsFeedingRebalanced elements = new ElementsFeedingRebalanced();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsFeedingRebalanced.GuiHandler());
