...
public class GuiPage4Gui extends ElementsFeedingRebalanced.ModElement {
	public static int GUIID = 9;
	public static HashMap guistate = new HashMap();
	public GuiPage4Gui(ElementsFeedingRebalanced instance) {
		super(instance, 23);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("feedingrebalanced:textures/page4gui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("feedingrebalanced:textures/plateofmuttonandpotatoes_1.png"));
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			...
			this.fontRenderer.drawString("1 Potato, 1 Mutton, 1 Plate", 25, 110, -16777216);
		}
