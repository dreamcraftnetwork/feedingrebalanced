...
public class GuiPage1Gui extends ElementsFeedingRebalanced.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiPage1Gui(ElementsFeedingRebalanced instance) {
		super(instance, 12);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("feedingrebalanced:textures/page1gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Welcome to Dreamcraft Network's", 12, 48, -16777216);
			this.fontRenderer.drawString("Feeding Rebalanced Mod", 28, 66, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 16, this.guiTop + 119, 30, 20, "<--"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 61, this.guiTop + 119, 50, 20, "Close"));
			this.buttonList.add(new GuiButton(2, this.guiLeft + 133, this.guiTop + 119, 30, 20, "-->"));
		}
