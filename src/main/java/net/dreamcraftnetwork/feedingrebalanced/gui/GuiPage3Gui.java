...
import net.dreamcraftnetwork.feedingrebalanced.procedure.ProcedurePage4;
import net.dreamcraftnetwork.feedingrebalanced.procedure.ProcedurePage2;
...
public class GuiPage3Gui extends ElementsFeedingRebalanced.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiPage3Gui(ElementsFeedingRebalanced instance) {
		super(instance, 18);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("feedingrebalanced:textures/page3gui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("feedingrebalanced:textures/steakandcarrot_recipe.png"));
			this.drawTexturedModalRect(this.guiLeft + 16, this.guiTop + 38, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Steak and Carrot Stew", 34, 11, -16777216);
			this.fontRenderer.drawString("Crafting Recipe", 43, 20, -16777216);
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedurePage2.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
		...
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedurePage4.executeProcedure($_dependencies);
			}
		}
	}
